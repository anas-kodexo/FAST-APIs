...
@book_router.post("/create-book", status_code=status.HTTP_201_CREATED, response_model=Book_model)
...
@book_router.patch("/book/{book_uid}", response_model=Book_model)
...
@book_router.delete("/delete-book/{book_uid}")
